...
This place is going to be a log of random thoughts, which I'm gathering and decorating these days during coffee brakes. Stay tuned and check out ◊link["/archive.html"]{Archive}!

At the daytime I do software engineering, mostly front-end. See my ◊link[cv-url]{CV} or ◊link[linked-url]{LinkedIn profile} for details. I admire functional programming, Clojure & ClojureScript, and learning OCaml for a greater good. I do a little bit of open-source, don't miss my ◊link[github-url]{GitHub} page for some fun stuff.
